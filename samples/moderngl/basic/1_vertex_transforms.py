# Reference - https://moderngl.readthedocs.io/en/latest/the_guide/basic.html#vertex-shader-transforms
import struct
import moderngl

ctx = moderngl.create_context(standalone=True)

print('ctx.info["GL_VENDOR"]: {}'.format(ctx.info["GL_VENDOR"]))
print('ctx.info["GL_RENDERER"]: {}'.format(ctx.info["GL_RENDERER"]))
print('ctx.info["GL_VERSION"]: {}'.format(ctx.info["GL_VERSION"]))
...
data = struct.unpack("{}f".format(NUM_VERTICES*2), buffer.read())
